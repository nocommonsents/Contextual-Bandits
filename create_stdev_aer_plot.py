...
ax.plot(data['t'],data['MostClicked'], label=r'$MostClicked$', lw='1.25', marker='o', markevery=500, fillstyle='none')
ax.plot(data['t'],data['MostRecent'], label=r'$MostRecent$', lw='1.25', marker='v', markevery=500, fillstyle='none')
...
ax.plot(data['t'],data['BinomialUCI'], label=r'$BinomialUCI$', color='darkorange', lw='1.25', marker='x', markevery=500, fillstyle='none')
...
plt.savefig("plots/stdevAER.png", dpi=240, bbox_inches='tight')
