...
class EnsembleBinomialUCIMod1(ContextualBanditPolicy):
    ...
    def getActionToPerform(self, visitor, possibleActions):
        ...
        current_uci_mod_values = [self.policy_ucis[str(c)]/math.exp(self.policy_runtime_to_count_ratios[str(c)]) for c in self.policies]
        #print current_uci_values
        #print current_runtime_values
