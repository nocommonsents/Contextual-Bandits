...
ax.plot(data['t'],data['SoftmaxContextual001']/data2['Random'], lw='1.25', label=r'$Softmax(0.01)$', marker='>', markevery=500, fillstyle='none')
...
ax.plot(data['t'],data['NaiveBayesContextual']/data2['Random'], lw='1.25', label=r'$NaiveBayes$', color='darkorange', marker='*', markevery=500, fillstyle='none')
...
plt.savefig("plots/minAERContextual.png", dpi=240, bbox_inches='tight')
