...
ax.set_title(r"$Context-Free\ Algorithm\ Comparison\ -\ Relative\ Mean\ AER$", fontsize='16', y=1.02)
ax.set_xlabel(r"$Number\ of\ Evaluations$")
ax.set_ylabel(r"$Relative\ Mean\ AER$")

ax.plot(data['t'],data['MostClicked']/data['Random'], label=r'$MostClicked$', lw='1.25', marker='o', markevery=500, fillstyle='none')
ax.plot(data['t'],data['MostRecent']/data['Random'], label=r'$MostRecent$', lw='1.25', marker='v', markevery=500, fillstyle='none')
...
ax.plot(data['t'],data['UCB1']/data['Random'], label=r'$UCB1$', color='lawngreen', lw='1.25', marker='8', markevery=500, fillstyle='none')
ax.plot(data['t'],data['BinomialUCI']/data['Random'], label=r'$BinomialUCI$', color='darkorange', lw='1.25', marker='x', markevery=500, fillstyle='none')
...
plt.savefig("plots/averageAER.png", dpi=240, bbox_inches='tight')
