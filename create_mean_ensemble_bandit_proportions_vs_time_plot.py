...
ax.plot(data['Time'],data['MostCTR'], label=r'$MostClicked$', lw='1.25', marker='o', markevery=500, fillstyle='none')
...
ax.plot(data['Time'],data['NaiveBayesContextual'], label=r'$NaiveBayesContextual$', lw='1.25', marker='*', markevery=500, fillstyle='none')
