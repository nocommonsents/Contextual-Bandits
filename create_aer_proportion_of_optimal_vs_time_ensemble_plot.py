...
ax.plot(data['TimeBin'],data['EnsembleBinomialUCIMod1']/data['MaxInRow'], lw='1.25', label=r'$EnsBinomialUCIMod1$', marker='+', markevery=20, fillstyle='none')
ax.plot(data['TimeBin'],data['EnsembleBinomialUCIMod2']/data['MaxInRow'], lw='1.25', label=r'$EnsBinomialUCIMod2$', color='fuchsia', marker='D', markevery=20, fillstyle='none')
