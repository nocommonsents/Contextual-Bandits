...
ax.set_title("Ensemble Bandit Algorithm Comparison - Variance of AER")
...
ax.plot(data['t'],data['EnsembleSoftmaxUpdateAll01'], label='EnsSoftmaxUpdateAll')
...
plt.savefig("plots/varAEREnsemble.png", bbox_inches='tight')
