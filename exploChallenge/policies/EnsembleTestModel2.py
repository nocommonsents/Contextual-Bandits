...
class EnsembleTestModel2(ContextualBanditPolicy):
    ...
    def getActionToPerform(self, visitor, possibleActions):
        ...
        #policy_two_scores_list = [self.policy_two_scores[v.getID()] for v in possibleActions]
        total_scores_list = [self.total_scores[v.getID()] for v in possibleActions]
        #print rargmax(policy_one_scores_list)
        #print rargmax(policy_two_scores_list)
        return possibleActions[rargmax(total_scores_list)]
