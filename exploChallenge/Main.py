...
class Main:
    ...
    def main(self, argv = sys.argv):
        ...
        outputFile = open("banditOutputs.txt", "a+")
        ...
        try:
            ...
            reader = YahooLogLineReader("/Users/bixlermike/Contextual-Bandits/exploChallenge/sampleData.txt", 136)
            #reader = YahooLogLineReader("/Users/bixlermike/Contextual-Bandits/exploChallenge/ydata-fp-td-clicks-v2_0.20111002-all", 136)
        ...
        #policy = RandomPolicy()
        #outputFile.write("Policy: Random Policy\n")
        #policy = eGreedy()
