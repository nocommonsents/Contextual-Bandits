...
ax.plot(data['t'],data['EnsembleBinomialUCIMod1'], lw='1.25', label=r'$EnsBinomialUCIMod1$', marker='+', markevery=500, fillstyle='none')
ax.plot(data['t'],data['EnsembleBinomialUCIMod2'], lw='1.25', label=r'$EnsBinomialUCIMod2$', color='fuchsia', marker='D', markevery=500, fillstyle='none')
