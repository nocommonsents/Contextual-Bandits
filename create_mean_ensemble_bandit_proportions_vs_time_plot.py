...
ax.plot(data['Time'],data['Softmax01'], label=r'$Softmax(0.1)$', lw='1.25', marker='s', color='darkorange', markevery=25, fillstyle='none')
ax.plot(data['Time'],data['NaiveBayesContextual'], label=r'$NaiveBayes$', lw='1.25', marker='*', color='fuchsia', markevery=25, fillstyle='none')
ax.plot(data['Time'],data['LinUCB01'], label=r'$LinUCB(0.1)$', lw='1.25', color='deepskyblue', marker='>', markevery=25, fillstyle='none')
ax.plot(data['Time'],data['SoftmaxContextual01'], label=r'$SoftmaxContextual(0.1)$', lw='1.25', color='greenyellow', marker='+', markevery=25, fillstyle='none')
