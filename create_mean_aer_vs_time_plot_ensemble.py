...
ax.plot(data['TimeBin'],data['EnsembleTS']/data['Random'], lw='1.25', label=r'$EnsTS$', color='darkorange', marker='<', markevery=50, fillstyle='none')
...
ax.plot(data['TimeBin'],data['EnsembleSoftmax001']/data['Random'], lw='1.25', label=r'$EnsSoftmax0.01$', color='greenyellow', marker='>', markevery=50, fillstyle='none')
ax.plot(data['TimeBin'],data['EBUCIM1']/data['Random'], lw='1.25', label=r'$EBUCIM1$', marker='+', markevery=50, fillstyle='none')
ax.plot(data['TimeBin'],data['EBUCIM2']/data['Random'], lw='1.25', label=r'$EBUCIM2$', color='fuchsia', marker='D', markevery=50, fillstyle='none')
...
#plt.tight_layout()
plt.savefig("plots/meanAERVsTimeEnsemble.png", dpi=120, bbox_inches='tight')
