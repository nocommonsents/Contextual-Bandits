...
class EnsemblePositiveReinforcementModel(ContextualBanditPolicy):
    ...
    def getActionToPerform(self, visitor, possibleActions):
        # Model keeps track of last result.  If a particular policy picked an arm
        # that yielded a positive reward, it gets to choose again at the next time step.
