...
python create_mean_ensemble_bandit_proportions_plot.py EBUCIM1
python create_mean_ensemble_bandit_proportions_plot.py EBUCIM2
...
python create_mean_ensemble_bandit_proportions_vs_time_plot.py EBUCIM1
python create_mean_ensemble_bandit_proportions_vs_time_plot.py EBUCIM2