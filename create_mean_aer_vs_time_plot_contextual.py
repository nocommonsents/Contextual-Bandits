...
ax.plot(data['TimeBin'],data['eGreedyContextual01']/data['Random'], lw='1.25', label=r'$e-Greedy(0.1)$', marker='o', markevery=500, fillstyle='none')
ax.plot(data['TimeBin'],data['eAnnealingContextual']/data['Random'], lw='1.25', label=r'$e-Annealing$', marker='v', markevery=500, fillstyle='none')
...
ax.plot(data['TimeBin'],data['LinUCB01']/data['Random'], lw='1.25', label=r'$LinUCB(0.1)$', marker='s', markevery=500, fillstyle='none')
...
#plt.tight_layout()
plt.savefig("plots/meanAERVsTimeContextual.png", dpi=120, bbox_inches='tight')
